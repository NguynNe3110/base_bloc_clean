...
mixin _$TodoDto {
  ...
  @override
  String toString() {
    return 'TodoDto(id: $id, title: $title, isCompleted: $isCompleted)';
  }
}
...
extension TodoDtoPatterns on TodoDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TodoDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, bool isCompleted)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
